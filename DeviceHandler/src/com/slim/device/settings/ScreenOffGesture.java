...
//                SlimActionConstants.ACTION_CAMERA).commit();
//        editor.putString(PREF_GESTURE_DOUBLE_SWIPE,
//                SlimActionConstants.ACTION_MEDIA_PLAY_PAUSE).commit();
//        editor.putString(PREF_GESTURE_ARROW_UP,
//                SlimActionConstants.ACTION_TORCH).commit();
//        editor.putString(PREF_GESTURE_ARROW_DOWN,
//                SlimActionConstants.ACTION_VIB_SILENT).commit();
//        editor.putString(PREF_GESTURE_ARROW_LEFT,
//                SlimActionConstants.ACTION_MEDIA_PREVIOUS).commit();
//        editor.putString(PREF_GESTURE_ARROW_RIGHT,
//                SlimActionConstants.ACTION_MEDIA_NEXT).commit();
        editor.putString(PREF_GESTURE_DOUBLE_TAP,
                SlimActionConstants.ACTION_WAKE_DEVICE).commit();
        editor.commit();
